...
export function MissionSection() {
  ...
  return (
    <section aria-labelledby="mission-heading" className="py-2 sm:py-4 lg:py-6 xl:py-8">
      <div className="py-4 container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-200">
        <h2
          id="mission-heading"
